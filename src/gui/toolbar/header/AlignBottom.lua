...
---@return AlignBottom
function AlignBottom.new(element)
    return AlignBottom:super(ToolbarHeaderButton.new(element))
end

function AlignBottom:initialize()
    AlignBottom:super().initialize(self)
